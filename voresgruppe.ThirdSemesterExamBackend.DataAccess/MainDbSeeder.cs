...
namespace voresgruppe.ThirdSemesterExamBackend.DataAccess
{
    public class MainDbSeeder : IMainDbSeeder
    {
        ...
        {
            _ctx.Hairstyles.Add(new HairstyleEntity(){Name = "kort", EstimatedTime = 40, Description = "det mindre langt", Price = 3, PossibleStyles = "2", IsStarterHairstyle = true, PathToImage = "../../../../assets/Kort.jpg"});
            _ctx.Hairstyles.Add(new HairstyleEntity(){Name = "spidser", EstimatedTime = 50, Description = "det blir nogenlunde lige", Price = 45, PossibleStyles = "1", IsStarterHairstyle = false, PathToImage = "../../../../assets/spidser.jpg"});
            _ctx.Hairstyles.Add(new HairstyleEntity(){Name = "gryde", EstimatedTime = 35, Description = "bedre end pandehår", Price = 20, PossibleStyles = "1", IsStarterHairstyle = true, PathToImage = "../../../../assets/Gryde.jpg"});
